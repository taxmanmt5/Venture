...
private slots:
    ...
    void on_BuyVC_clicked();
    void on_SellVCBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputVC_textChanged(const QString &arg1);
    ...
    QString BuyVC(QString OrderType, double Quantity, double Rate);
    QString SellVC(QString OrderType, double Quantity, double Rate);
