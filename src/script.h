...
#ifndef H_Venture_SCRIPT
#define H_Venture_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CVentureAddress
 */
...
public:
    ...
    // Pre-version-0.6, Venture always counted CHECKMULTISIGs
