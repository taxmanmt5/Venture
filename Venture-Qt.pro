...
contains(Venture_NEED_QT_PLUGINS, 1) {
    DEFINES += Venture_NEED_QT_PLUGINS
...
HEADERS += src/qt/Venturegui.h \
    ...
    src/qt/Ventureaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/Venture.cpp src/qt/Venturegui.cpp \
    ...
    src/qt/Ventureaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/Venturestrings.cpp \
    src/qt/Ventureamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/Venture.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/Venture_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Venture-qt.rc
...
windows:RC_FILE = src/qt/res/Venture-qt.rc
...
macx:ICON = src/qt/res/icons/Venture.icns
macx:TARGET = "Venture-Qt"
